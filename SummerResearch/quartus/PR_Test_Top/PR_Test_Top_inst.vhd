	component PR_Test_Top is
		port (
			ddr4_emif_global_reset_n_reset_n : in    std_logic                     := 'X';             -- reset_n
			ddr4_emif_pll_ref_clk_clk        : in    std_logic                     := 'X';             -- clk
	...
	u0 : component PR_Test_Top
		port map (
			ddr4_emif_global_reset_n_reset_n => CONNECTED_TO_ddr4_emif_global_reset_n_reset_n, -- ddr4_emif_global_reset_n.reset_n
			ddr4_emif_pll_ref_clk_clk        => CONNECTED_TO_ddr4_emif_pll_ref_clk_clk,        --    ddr4_emif_pll_ref_clk.clk
