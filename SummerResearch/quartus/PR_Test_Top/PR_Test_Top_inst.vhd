	component PR_Test_Top is
		port (
			sdram_global_reset_n_reset_n   : in    std_logic                     := 'X';             -- reset_n
			sdram_pll_ref_clk_clk          : in    std_logic                     := 'X';             -- clk
	...
	u0 : component PR_Test_Top
		port map (
			sdram_global_reset_n_reset_n   => CONNECTED_TO_sdram_global_reset_n_reset_n,   -- sdram_global_reset_n.reset_n
			sdram_pll_ref_clk_clk          => CONNECTED_TO_sdram_pll_ref_clk_clk,          --    sdram_pll_ref_clk.clk
