	PR_Test_Top u0 (
		.sdram_global_reset_n_reset_n   (_connected_to_sdram_global_reset_n_reset_n_),   //   input,   width = 1, sdram_global_reset_n.reset_n
		.sdram_pll_ref_clk_clk          (_connected_to_sdram_pll_ref_clk_clk_),          //   input,   width = 1,    sdram_pll_ref_clk.clk
