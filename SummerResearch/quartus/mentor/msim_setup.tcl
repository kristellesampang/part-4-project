...
# ----------------------------------------
# ACDS 24.1 115 win32 2025.12.11.13:34:06
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "OutputBuffer.OutputBuffer"
}
...
alias dev_com {
  ...
  if [string is false -strict [modelsim_ae_select $FORCE_MODELSIM_AE_SELECTION]] {
    eval  qrun -compile -noautoorder -parallel -outdir ./libraries -vlog.options $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS -end \
     ...
     -makelib twentynm_ver "$QUARTUS_INSTALL_DIR/eda/sim_lib/twentynm_atoms.v" -end \
     -makelib twentynm_ver "$QUARTUS_INSTALL_DIR/eda/sim_lib/mentor/twentynm_atoms_ncrypt.v" -end \
     -makelib twentynm_hip_ver "$QUARTUS_INSTALL_DIR/eda/sim_lib/mentor/twentynm_hip_atoms_ncrypt.v" -end \
     -makelib twentynm_hip_ver "$QUARTUS_INSTALL_DIR/eda/sim_lib/twentynm_hip_atoms.v" -end \
     -makelib twentynm_hssi_ver "$QUARTUS_INSTALL_DIR/eda/sim_lib/mentor/twentynm_hssi_atoms_ncrypt.v" -end \
     -makelib twentynm_hssi_ver "$QUARTUS_INSTALL_DIR/eda/sim_lib/twentynm_hssi_atoms.v" -end \
     ...
     -makelib twentynm "$QUARTUS_INSTALL_DIR/eda/sim_lib/mentor/twentynm_atoms_ncrypt.v" -end \
     -makelib twentynm "$QUARTUS_INSTALL_DIR/eda/sim_lib/twentynm_atoms.vhd" -end \
     -makelib twentynm "$QUARTUS_INSTALL_DIR/eda/sim_lib/twentynm_components.vhd" -end \
     -makelib twentynm_hip "$QUARTUS_INSTALL_DIR/eda/sim_lib/mentor/twentynm_hip_atoms_ncrypt.v" -end \
     -makelib twentynm_hip "$QUARTUS_INSTALL_DIR/eda/sim_lib/twentynm_hip_components.vhd" -end \
     -makelib twentynm_hip "$QUARTUS_INSTALL_DIR/eda/sim_lib/twentynm_hip_atoms.vhd" -end \
     -makelib twentynm_hssi "$QUARTUS_INSTALL_DIR/eda/sim_lib/mentor/twentynm_hssi_atoms_ncrypt.v" -end \
     -makelib twentynm_hssi "$QUARTUS_INSTALL_DIR/eda/sim_lib/twentynm_hssi_components.vhd" -end \
     -makelib twentynm_hssi "$QUARTUS_INSTALL_DIR/eda/sim_lib/twentynm_hssi_atoms.vhd" -end \
