...
namespace eval Test_PR_CTRLR {
  proc get_design_libraries {} {
    set libraries [dict create]
    dict set libraries alt_pr_1911   1
    dict set libraries Test_PR_CTRLR 1
    return $libraries
  }
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    lappend design_files "vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/Test_PR_CTRLR.vhd"]\"  -work Test_PR_CTRLR"                                                                            
    return $design_files
  }
