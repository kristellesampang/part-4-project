// SDRAM_altera_mm_interconnect_1920_mnl7iba.v
...
`timescale 1 ps / 1 ps
module SDRAM_altera_mm_interconnect_1920_mnl7iba (
		...
		input  wire        col_if_avl_rst_in_reset_bridge_in_reset_reset, // col_if_avl_rst_in_reset_bridge_in_reset.reset,        Reset Input
		input  wire        arch_cal_master_clk_clk                        //                     arch_cal_master_clk.clk,          Clock Input
	);
	...
	SDRAM_altera_merlin_master_translator_192_lykd4la #(
		.AV_ADDRESS_W                (30),
		.AV_DATA_W                   (32),
		.AV_BURSTCOUNT_W             (1),
		.AV_BYTEENABLE_W             (4),
	...
	SDRAM_altera_merlin_slave_translator_191_x56fcki #(
		.AV_ADDRESS_W                   (24),
		.AV_DATA_W                      (32),
		.UAV_DATA_W                     (32),
		.AV_BURSTCOUNT_W                (1),
