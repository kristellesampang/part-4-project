// SDRAM_altera_ip_col_if_1911_rqtxiaa.v
...
`timescale 1 ps / 1 ps
module SDRAM_altera_ip_col_if_1911_rqtxiaa (
		input  wire        avl_clk_in_clk,         //  avl_clk_in.clk,          Clock Input
		output wire        avl_clk_out_clk,        // avl_clk_out.clk,          Clock Output
		input  wire        avl_rst_in_reset,       //  avl_rst_in.reset,        Reset Input
		output wire        avl_rst_out_reset,      // avl_rst_out.reset,        Reset Output
	...
	SDRAM_altera_avalon_mm_bridge_2010_xnk2xbi #(
		.DATA_WIDTH               (32),
		.SYMBOL_WIDTH             (8),
		.HDL_ADDR_WIDTH           (30),
		.BURSTCOUNT_WIDTH         (1),
	...
	SDRAM_alt_mem_if_jtag_master_191_rksoe3i #(
		.USE_PLI     (0),
		.PLI_PORT    (50000),
		.FIFO_DEPTHS (2)
	) colmaster (
	...
	SDRAM_altera_mm_interconnect_1920_mlnx7ry mm_interconnect_0 (
