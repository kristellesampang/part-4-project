...
# ----------------------------------------
# ACDS 24.1 115 win32 2025.12.18.19:10:12
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "SDRAM.SDRAM"
}
...
append ELAB_OPTIONS [subst [SDRAM::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [SDRAM::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [SDRAM::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [SDRAM::normalize_path "$file"]
  set normalized_dest [SDRAM::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [SDRAM::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [SDRAM::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [SDRAM::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [SDRAM::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
