...
# ----------------------------------------
# If PR_Test_Top_jtag_uart_0 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 24.1 115 win32 2026.02.03.13:10:33
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "PR_Test_Top_jtag_uart_0.PR_Test_Top_jtag_uart_0"
}
...
append ELAB_OPTIONS [subst [PR_Test_Top_jtag_uart_0::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [PR_Test_Top_jtag_uart_0::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [PR_Test_Top_jtag_uart_0::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [PR_Test_Top_jtag_uart_0::normalize_path "$file"]
  set normalized_dest [PR_Test_Top_jtag_uart_0::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [PR_Test_Top_jtag_uart_0::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [PR_Test_Top_jtag_uart_0::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [PR_Test_Top_jtag_uart_0::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [PR_Test_Top_jtag_uart_0::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
