	mSGDMA_PR u0 (
		...
		.mm_read_burstcount           (_connected_to_mm_read_burstcount_),           //  output,    width = 2,                 .burstcount
		...
		.mm_write_burstcount          (_connected_to_mm_write_burstcount_)           //  output,    width = 2,                 .burstcount
	);
