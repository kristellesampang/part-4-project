...
entity systolic_array_int16 is
port(
    clk          : in  bit_1;
    reset        : in  bit_1;
    data_shift   : in  input_shift_matrix_int16;
    weight_shift : in  input_shift_matrix_int16;
    enabled_PE   : in  enabled_PE_matrix_int16;
    output       : out systolic_array_matrix_output_int16
);
end systolic_array_int16;

architecture behaviour of systolic_array_int16 is
    signal data_bus   : data_bus_matrix_int16   := (others => (others => (others => '0')));
    signal weight_bus : weight_bus_matrix_int16 := (others => (others => (others => '0')));
    signal results    : result_matrix_int16     := (others => (others => (others => '0')));
begin
