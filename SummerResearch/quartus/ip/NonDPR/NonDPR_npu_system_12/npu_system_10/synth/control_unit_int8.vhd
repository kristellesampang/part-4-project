...
port(
    ...
    data_shift      : out input_shift_matrix_int8;
    weight_shift    : out input_shift_matrix_int8;
    cycle_count     : out integer;
    PE_enabled_mask : out enabled_PE_matrix_int8;
    completed       : out bit_1;
...
end control_unit_int8;

architecture behaviour of control_unit_int8 is
    signal data_reg   : input_shift_matrix_int8 := (others => (others => '0'));
    signal weight_reg : input_shift_matrix_int8 := (others => (others => '0'));
    signal run_enable : bit_1 := '0';
    signal count      : integer := 0;
    signal mask_internal      : enabled_PE_matrix_int8 := (others => (others => '0'));
