...
# ----------------------------------------
# If data_mem is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "data_mem.data_mem"
}
...
append ELAB_OPTIONS [subst [data_mem::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [data_mem::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [data_mem::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [data_mem::normalize_path "$file"]
  set normalized_dest [data_mem::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [data_mem::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [data_mem::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [data_mem::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [data_mem::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
