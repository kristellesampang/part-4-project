...
ENTITY OutputBuffer_ram_2port_2041_375fvbi IS
    PORT
    (
        aclr       : IN STD_LOGIC  := '0';
...
END OutputBuffer_ram_2port_2041_375fvbi;


ARCHITECTURE SYN OF OutputBuffer_ram_2port_2041_375fvbi IS
...
BEGIN
    ...
    GENERIC MAP (
            ...
            indata_reg_b  => "CLOCK0",
            init_file  => "/home/pratham/Documents/Github/part-4-project/SummerResearch/Memory/Buffers/MIFs/OutputBuffer.mif",
