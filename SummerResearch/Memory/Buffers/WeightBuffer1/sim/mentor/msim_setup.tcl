...
# ----------------------------------------
# If WeightBuffer1 is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "WeightBuffer1.WeightBuffer1"
}
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [WeightBuffer1::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
...
alias file_copy {
  ...
  set normalized_src [WeightBuffer1::normalize_path "$file"]
  set normalized_dest [WeightBuffer1::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [WeightBuffer1::get_dpi_libraries "$QSYS_SIMDIR"]]
...
alias com {
  ...
  set design_files [dict merge [WeightBuffer1::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
