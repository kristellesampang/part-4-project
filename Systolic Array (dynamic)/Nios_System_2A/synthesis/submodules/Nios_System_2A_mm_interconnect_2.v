// Nios_System_2A_mm_interconnect_2.v
...
module Nios_System_2A_mm_interconnect_2 (
		...
		output wire [3:0]  WEIGHT_BRAM_s2_byteenable,                          //                                             .byteenable
		output wire        WEIGHT_BRAM_s2_chipselect,                          //                                             .chipselect
	...
	altera_merlin_slave_translator #(
		...
		.av_writedata           (WEIGHT_BRAM_s2_writedata),                                                   //                         .writedata
		.av_byteenable          (WEIGHT_BRAM_s2_byteenable),                                                  //                         .byteenable
		.av_chipselect          (WEIGHT_BRAM_s2_chipselect),                                                  //                         .chipselect
		.av_clken               (WEIGHT_BRAM_s2_clken),                                                       //                         .clken
		.av_read                (),                                                                           //              (terminated)
