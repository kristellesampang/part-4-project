...
\section{Verification and Results} \label{sec: verification}
    ...
    % add section: hardware synthesis, talk about how we added UART here as well, mostly for transmission, to confirm in the terminal that yesss this atually works in real life
    % add figures from compilation report
