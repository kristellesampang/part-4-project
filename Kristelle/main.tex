...
\newcommand{\baselineNxN}{
    \begin{figure}[ht]
        \centering
        \includegraphics[width=0.2\linewidth]{results/Latency of Baseline Systolic Array on Different NxN sizes.png}
...
\newcommand{\baselineNxEight}{
    \begin{figure}[ht]
        \centering
        \includegraphics[width=0.2\linewidth]{results/Latency of Baseline Systolic Array on Varying Input Matrix Size.png}
        \caption{Latency of Baseline Systolic Array on Varying Input Matrix Size}
        \label{fig:latency_baseline_nx8}
    \end{figure}
}
...
\newcommand{\baselineOnexOne}{
    \begin{figure}[ht]
        ...
        \label{fig:latency_baseline_1x1}
    \end{figure}
}
...
\newcommand{\baselineOnexOneMATLAB}{
    \begin{figure}[ht]
        ...
        \label{fig:latency_baseline_1x1_matlab}
    \end{figure}
}
...
\newcommand{\baselineTwoxTwo}{
    \begin{figure}[ht]
        ...
        \label{fig:latency_baseline_2x2}
    \end{figure}
}
...
\newcommand{\baselineTwoxTwoMATLAB}{
    \begin{figure}[ht]
        ...
        \label{fig:latency_baseline_2x2_matlab}
    \end{figure}
}
...
\newcommand{\baselineThreexThree}{
    \begin{figure}[ht]
        ...
        \label{fig:latency_baseline_3x3}
    \end{figure}
}
\newcommand{\baselineThreexThreeMATLAB}{
    \begin{figure}[ht]
        ...
        \label{fig:latency_baseline_3x3_matlab}
    \end{figure}
}
...
\newcommand{\baselineFourxFour}{
    \begin{figure}[ht]
        ...
        \label{fig:latency_baseline_4x4}
    \end{figure}
}
...
\newcommand{\baselineFourxFourMATLAB}{
    \begin{figure}[ht]
        ...
        \label{fig:latency_baseline_4x4_matlab}
    \end{figure}
}
...
\newcommand{\baselineFivexFive}{
    \begin{figure}[ht]
        ...
        \label{fig:latency_baseline_5x5}
    \end{figure}
}
...
\newcommand{\baselineFivexFiveMATLAB}{
    \begin{figure}[ht]
        ...
        \label{fig:latency_baseline_5x5_matlab}
    \end{figure}
}
...
\newcommand{\baselineSixxSix}{
    \begin{figure}[ht]
        ...
        \label{fig:latency_baseline_6x6}
    \end{figure}
}
\newcommand{\baselineSixxSixMATLAB}{
    \begin{figure}[ht]
        ...
        \label{fig:latency_baseline_6x6_matlab}
    \end{figure}
}
...
\newcommand{\baselineSevenxSeven}{
    \begin{figure}[ht]
        ...
        \label{fig:latency_baseline_7x7}
    \end{figure}
}
\newcommand{\baselineSevenxSevenMATLAB}{
    \begin{figure}[ht]
        ...
        \label{fig:latency_baseline_7x7_matlab}
    \end{figure}
}
...
\newcommand{\baselineEightxEight}{
    \begin{figure}[ht]
        ...
        \label{fig:latency_baseline_8x8}
    \end{figure}
}
\newcommand{\baselineEightxEightMATLAB}{
    \begin{figure}[ht]
        ...
        \label{fig:latency_baseline_8x8_matlab}
    \end{figure}
}
