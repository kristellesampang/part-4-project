...
\section{Literature Review} \label{sec: literature review}
    ...
    % Now, review what others have done to solve the sparsity problem.
        ...
        To further improve efficiency, compressed data formats are investigated to reduce the memory access and 

        \textcite{palacios_systolic_2025,kim_fpga_2021} found that with structured pruning, where entire rows or columns of weights are pruned, the hardware can be optimised to skip entire rows or columns of computations. This is more efficient than unstructured pruning, where individual weights are pruned, as it maintains the regularity of the data access patterns. However, this requires a more complex control logic to manage the skipping of rows and columns, adding to the design complexity.
