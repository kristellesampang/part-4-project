...
\newcommand{\baselineDataflowImage}{
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.5\linewidth]{figures/baseline_systolic_array_dataflow.jpg.jpg}
