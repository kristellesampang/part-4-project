...
\section{Verification and Results} \label{sec: verification}
    ...
    - the dense 8x8 matrix will confirm that the systolic array works as intended
    - the 4x8 matrix will show how the systolic array can adapt to different sizes
    - the 1x8 matrix will show no matter how sparse the matrix is, the systolic array will still have to process the entire row, showing the inefficiency of the baseline systolic array when handling sparsity
    ...
    - what part was verified and how? how can we say yes, the baseline systolic array works as intended?
