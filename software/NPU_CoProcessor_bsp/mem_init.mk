...
# Memory: DATA_BRAM
MEM_0 := matrix_data_32bit
$(MEM_0)_NAME := DATA_BRAM
...
$(MEM_0)_START := 0x08011000
$(MEM_0)_END := 0x0801103f
$(MEM_0)_SPAN := 0x00000040
$(MEM_0)_HIERARCHICAL_PATH := DATA_BRAM
$(MEM_0)_WIDTH := 32
...
.PHONY: DATA_BRAM
DATA_BRAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: WEIGHT_BRAM
MEM_1 := Nios_System_2A_WEIGHT_BRAM
$(MEM_1)_NAME := WEIGHT_BRAM
...
$(MEM_1)_START := 0x08011080
$(MEM_1)_END := 0x0801108f
$(MEM_1)_SPAN := 0x00000010
$(MEM_1)_HIERARCHICAL_PATH := WEIGHT_BRAM
$(MEM_1)_WIDTH := 32
...
.PHONY: WEIGHT_BRAM
WEIGHT_BRAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: onchip_memory
MEM_2 := Nios_System_2A_onchip_memory
...
$(MEM_2)_START := 0x08008000
$(MEM_2)_END := 0x0800cfff
$(MEM_2)_SPAN := 0x00005000
